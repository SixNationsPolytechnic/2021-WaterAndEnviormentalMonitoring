/*
 * Used to allow for OTA Updates for nodes.
 * 
 * URL_version and URL_bin should be changed when using different repo or branch.
 * rootCACertificate should likely be swapped to a different one
 * 
 * Source: https://github.com/programmer131/ESP8266_ESP32_SelfUpdate
 */
...
void firmwareUpdate() {if (firmwareUpdateCheck()) firmwareUpdateExecute();} // just checks if it needs an update and updates if so
