/*
 * Code for a sensor for The SNP WSP (https://snpweather.xyz)
 * Makes use of OTA Update system for ESP8266 from https://github.com/programmer131/ESP8266_ESP32_SelfUpdate
 */
